    ...
    <div className="orderf">
      <form className="orderform" >
        <div className="formgroup">
          <input type="text" value={location.state.Pname} className="formcontrol-o" id="pname" placeholder=" Product name" name="item_name" />
        ...
        <button type="submit" onClick={notify} className="btn btn-primary">
          <Link to="/Orders1/OrderSucess" >Place Order</Link>
